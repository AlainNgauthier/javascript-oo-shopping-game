...
const calculatePoints = (prod, tBill) => {
    ...
    player.addPoints(pointsToBill);
    player.addPoints(pointsForExpDate);
    if(prod.prototype === MagicProduct.prototype) {
